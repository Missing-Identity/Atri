...
default_state = json.loads('{"b":{"styles":{"width":"","height":"","minWidth":"","minHeight":"","maxWidth":"","maxHeight":"","overflow":""},"custom":{"cartesianGrid":{"show":false,"strokeDasharray":""},"data":[],"xAxis":{"show":false,"key":""},"yAxis":{"show":false},"toolTip":{"show":false},"legend":{"show":false},"stacked":false,"options":{}}}}')
...
class Atri:
	...
	@property
	def b(self):
		self._getter_access_tracker["b"] = {}
		return self._b
	@b.setter
	def b(self, new_state):
		self._setter_access_tracker["b"] = {}
		global default_state
		self._b = BarChart(new_state, default_state["b"])
